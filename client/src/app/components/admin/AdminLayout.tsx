...
import {
  ...
  ChevronRight, X, Activity, BarChart3, IndianRupee,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Pricing",     path: "/admin/pricing",     icon: IndianRupee,     color: "#14b8a6"         },
  { label: "Reports",     path: "/admin/reports",     icon: BarChart3,       color: "#ec4899"         },
